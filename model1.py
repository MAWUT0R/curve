...
# SVM model
X = df[['volume_usd', 'tvl_usd', 'active_users', 'tx_count', 'day_of_week']]
y = df['volume_usd']
...
svm_pred = svm_model.predict(df[['volume_usd', 'tvl_usd', 'active_users', 'tx_count', 'day_of_week']].tail(7))
...
predictions.to_json('predictions.json', orient='records')
